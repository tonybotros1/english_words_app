...
class DatabaseHelper {
  static const wordsTable = 'wordsTable';
  static const idColumn = 'id';
  static const englishColumn = 'enword';
  static const arabicColumn = 'arword';
  static const descriptionColumn = 'description';
  static const dateColumn = 'date';
  static const favoriteColumn = 'favorite';
  ...
  void _onCreate(Database db, int newVersion) async {
    await db.execute('''
      CREATE TABLE $wordsTable (
        ...
        $englishColumn TEXT NOT NULL,
        $arabicColumn TEXT NOT NULL,
...
// get in DESC sorting
  Future<List<Map<String, dynamic>>> queryAllOrderBy(String table) async {
    ...
    return await dbClient.query(
      table,
      orderBy: '$dateColumn DESC, $idColumn DESC',
    );
  }

  Future<List<Map<String, dynamic>>> queryAllFilterBy(
      String table, filter) async {
    Database dbClient = await db;
    return await dbClient.query(
      table,
      orderBy: '$dateColumn DESC, $idColumn DESC',
...
// update values
  Future<int> update(String table, Map<String, dynamic> values, String idColumn,
      int id) async {
    Database dbClient = await db;
    return await dbClient
