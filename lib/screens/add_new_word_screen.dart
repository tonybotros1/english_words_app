          ...
          child: ListView(
            ...
            children: [
              _TextInput(
                ...
                controller: newWordController.enWord,
                icon: Icons.language,
              ...
              _TextInput(
                ...
                controller: newWordController.arWord,
              ...
              _TextInput(
                ...
                controller: newWordController.notes,
                icon: Icons.notes,
                maxLines: 7,
              ),
              ...
              Obx(
                () => FilledButton.icon(
                  onPressed: newWordController.loading.value
                      ? null
                      : () async {
                          if (formKey.currentState?.validate() != true) {
                            return;
                          }
                          final saved = await newWordController.addNewWord();
                          if (saved) {
                            Get.back(result: true);
                          }
                        },
                  icon: newWordController.loading.value
                      ? const SizedBox(
                          width: 18,
                          height: 18,
